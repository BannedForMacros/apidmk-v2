...
@Repository
@Transactional
public class ArticuloMSSQL implements IArticulo {
   @Autowired
   @Qualifier("SQLSERVER")
   private DataSource con;
   private static Log log = LogFactory.getLog(ArticuloMSSQL.class);
      ...
      try {
         ...
         try {
            ...
            try {
               ...
               try {
                  pstmt.setInt("@opc", 3);
                  pstmt.setString("@CodListaPrecio", listaPrecio);
                  pstmt.setString("@Codalmacen", codalmacen);
                  ResultSet rs = pstmt.executeQuery();
         ...
         try {
            ...
            try {
               ...
               try {
                  ...
                  pstmt.setString("@XMLARTICULO", ConvertirAxml.toXML(articulo));
